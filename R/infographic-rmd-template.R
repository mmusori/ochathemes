...
infographic <- function(number_sections = FALSE,
    ...
    template <- "default"
    code_folding <- "none"
    pandoc_args  <- c(pandoc_args, rmarkdown::pandoc_variable_arg("logo", system.file("rmarkdown", "templates", "infographic", "resources", "img", "logo-unocha.svg", package = "ochathemes")))
    
    dep <- htmltools::htmlDependency(
                          name = "infographic",
                          version = "0.1.0",
                          system.file("rmarkdown", "templates", "infographic", "resources", package = "ochathemes"),
                          stylesheet = "infographic.css"
                      )
    ...
    args <- c(
        ...
        rmarkdown::pandoc_path_arg(
                       system.file("rmarkdown", "templates", "infographic", "base.html", package = "ochathemes")
                   )
    )
